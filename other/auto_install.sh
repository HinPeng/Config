...
set_env()
{
    env_path="/usr/local/cuda-${cuda_big_version}/bin:"
    #env_library="/usr/local/cuda-${cuda_big_version}/lib64:/usr/local/nccl/lib:"
    env_library="/usr/local/cuda-${cuda_big_version}/lib64:"
...
install_perseus()
{
    ...
    perseus_env_file="perseus_cuda${cuda_big_version}_env"
...
if [ "$os" = "ubuntu" ]; then
    ...
    #driver_file_ubuntu="nvidia-diag-driver-local-repo-${ubuntu_version}-${driver_version}_1.0-1_amd64.deb"
